    ...
    return (
        <section id="about" className="bg-black text-white min-h-screen flex flex-col items-center px-6 sm:px-12 lg:px-24 py-12">
            ...
            <div className="max-w-4xl text-center mb-12">
                <h1 className="text-4xl sm:text-5xl font-extrabold mb-4 font-smooch uppercase">
                    Capturing Stories through the Lens
                </h1>
                <p className="text-lg sm:text-xl font-light text-gray-300 pt-serif">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-16">
                ...
                <div className="lg:w-1/2 text-center lg:text-left">
                    <p className="text-lg pt-serif sm:text-xl font-light text-gray-300 mb-6 leading-relaxed">
                    ...
                    <p className="text-lg pt-serif sm:text-xl font-light text-gray-300 leading-relaxed">
